    ...
    render() {
        ...
        return (
            ...
            >
                    ...
                    <div className="table-responsive">
                        <table className="table table-borderless table-middle mb-0">
                            <tbody>
                                <tr>
                                    <td>5 Star</td>
                                    <td className="w-50"><Progress color="success" value={85} /></td>
                                    <td>7.14%</td>
                                </tr>
                                <tr>
                                    <td>4 Star</td>
                                    <td className="w-50"><Progress color="success" value={55} /></td>
                                    <td>6.14%</td>
                                </tr>
                                <tr>
                                    <td>3 Star</td>
                                    <td className="w-50"><Progress color="success" value={75} /></td>
                                    <td>3.14%</td>
                                </tr>
                                <tr>
                                    <td>2 Star</td>
                                    <td className="w-50"><Progress color="success" value={65} /></td>
                                    <td>2%</td>
                                </tr>
                                <tr>
                                    <td>1 Star</td>
                                    <td className="w-50"><Progress color="success" value={25} /></td>
                                    <td>1%</td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <RctCardFooter>
                    <Button component={Link} to="/app/pages/report" variant="raised" className="btn-success text-white">
                        View All
                    </Button>
                </RctCardFooter>
            </RctCard>
