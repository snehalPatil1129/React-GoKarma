    ...
    render() {
        return (
            <div className="lazy-up">
                <a href="javascript:void(0);" className="square-30 bg-danger card-top-action"><i className="ti-id-badge"></i></a>
                <div className="card pt-30">
                    ...
                    <div className="card-foot d-flex align-self-end">
                        <Button variant="raised" size="small" onClick={() => this.onAccept()} className="btn-success mr-5 mb-10 text-white"><IntlMessages id="button.accept" /></Button>
                        <Button variant="raised" size="small" onClick={() => this.onReject()} className="btn-secondary mb-10 text-white"><IntlMessages id="button.reject" /></Button>
                    </div>
                </div>
