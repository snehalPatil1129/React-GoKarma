  ...
  render() {
    return (
      <div className="about-wrapper">
        <PageTitleBar title="About Us" match={this.props.match} />
          ...
          <div className="row">
            <div className="col-sm-12 col-md-4">
              <RctCard>
                ...
                <div className="card-content text-center p-30">
                  ...
                  <p>
                    Vestibulum ultrices ligula sit amet augue interdum
                    fermentum. Vestibulum sed nisi ornare, tincidunt ante et,
                    tempus metus. Nunc pellentesque purus odio, eu dictum mi
                    luctus vitae. Class aptent taciti sociosqu ad litora
                    torquent per conubia nostra, per inceptos himenaeos.
                    Maecenas fermentum interdum elit,{" "}
                  </p>
                </div>
              </RctCard>
            </div>
            ...
            <div className="col-sm-12 col-md-4">
              <RctCard>
                <div className="card-image">
                  <img
                    src={require("../../assets/img/about-card-3.png")}
                    alt="about card"
                    className="img-fluid"
                    width="485"
                    height="323"
