...
class TaskStatusFilter extends Component {
    ...
    render() {
        ...
        return (
            <Scrollbars className="rct-scroll" autoHide style={{ height: "calc(100vh - 220px)" }}>
                ...
                <div className="filters">
                    <List subheader={<ListSubheader disableSticky>Filters</ListSubheader>}>
                        <ListItem button onClick={() => this.props.getCompletedTodosAction()}>
                            <i className="ti-check-box mr-2"></i>
                            <span className="filter-title"><IntlMessages id="widgets.done" /></span>
                        </ListItem>
                        <ListItem button onClick={() => this.props.getDeletedTodosAction()}>
                            <i className="ti-trash mr-2"></i> <span className="filter-title">
                                <IntlMessages id="widgets.deleted" />
                            </span>
                        </ListItem>
                        <ListItem button onClick={() => this.props.getStarredTodosAction()}>
                            <i className="ti-star mr-2"></i> <span className="filter-title">
                                <IntlMessages id="widgets.starred" />
                            </span>
                        </ListItem>
                    </List>
                </div>
