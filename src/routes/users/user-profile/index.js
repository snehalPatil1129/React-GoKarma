                ...
                <div className="card">
                  <div className="media">
                    ...
                    <div className="media-body pt-10">
                      ...
                      <Button variant="raised" className="gradient-primary text-white btn-icon mr-10 mb-10">Accept <i className="zmdi zmdi-check-circle"></i></Button>
                      <Button variant="raised" className="gradient-warning text-white btn-icon mr-10 mb-10">Reject <i className="zmdi zmdi-delete"></i></Button>
                    </div>
                  </div>
                </div>
              </div>
