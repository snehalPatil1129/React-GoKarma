  ...
  render() {
    ...
    return (
      <div className="address-wrapper">
        <h2 className="heading">Select default address</h2>
        ...
        <div className="py-50 w-50">
          <Collapse isOpen={this.state.collapse}>
            <div className="mb-20">
              ...
              <span>
                Be sure to click "Deliver to this address" when you have
                finished.{" "}
              </span>
            </div>
            <Form>
              <div className="row">
                <div className="col-md-6">
                  <FormGroup>
                    <Label className="col-form-label" for="city">
                      City
                    </Label>
                    <Input
                      type="text"
                ...
                <div className="col-md-6">
                  <FormGroup>
                    <Label className="col-form-label" for="zipcode">
                      Zip Code
                    </Label>
                    <Input
                      type="text"
              ...
              <FormGroup>
                <Label className="col-form-label" for="address1">
                  Address Line 1
                </Label>
                <Input
                  type="text"
              ...
              <FormGroup>
                <Label className="col-form-label" for="address2">
                  Address Line 2
                </Label>
                <Input
                  type="text"
              ...
              <div className="row">
                <div className="col-md-6">
                  <FormGroup>
                    <Label className="col-form-label" for="apt">
                      Apt.
                    </Label>
                    <Input
                      type="text"
              ...
              <FormGroup>
                <Label className="col-form-label" for="altphone">
                  Alt Phone No.
                </Label>
                <Input
                  type="tel"
        ...
        >
          ...
          <DialogActions>
            <Button
              ...
              onClick={() => this.handleCloseDeleteAddressAlert()}
            >
              Disagree
            </Button>
            <Button
