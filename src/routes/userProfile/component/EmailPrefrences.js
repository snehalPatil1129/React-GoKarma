            ...
            <ul className="list-unstyled">
              <li className="d-flex justify-content-between">
                <div className="">
                  ...
                  <p>
                    New products and feature updates, as well as occasional
              ...
              <li className="d-flex justify-content-between">
                <div className="">
                  ...
                  <p>
                    Timely advice to help you make the most of our features.
                  </p>
                </div>
                <Switch
              ...
              <li className="d-flex justify-content-between">
                <div className="">
                  <h5>Inbox</h5>
                  <p>
                    Answers to your questions, comments, chat notifications and
                    more.
                  </p>
                </div>
                <Switch
              ...
              <li className="d-flex justify-content-between">
                <div className="">
                  ...
                  <p>
                    Notifications about upcoming events & community activity.
                  </p>
                </div>
                <Switch
              ...
              <li className="d-flex justify-content-between">
                <div className="">
                  <h5>Research</h5>
                  <p>
                    Invitations to participate in surveys, usability tests and
                    more. Only a few per year.
                  </p>
                </div>
                <Switch
