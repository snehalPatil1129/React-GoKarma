    ...
    return (
      <div className="date-time-wrapper">
        ...
        <div className="alert alert-info">
          <p>Date And time pickers components, that implements material design for material-ui v1.
          There are multiple ways to use this component to allow greater flexibility and with better customization.
            If You want ti see more demos <a href="https://github.com/dmtrKovalenko/material-ui-pickers" className="btn btn-danger btn-small mx-10">Click</a> here.
            </p>
        </div>
        <div className="row">
          <RctCollapsibleCard
